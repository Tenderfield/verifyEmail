...
class VerifyEmail {
    ...
    private $dont_validate_from=false;
    ...
    public function disable_validate_from() {
        $this->dont_validate_from = true;
    }
    public function enable_validate_from() {
        $this->dont_validate_from = false;
    }
    ...
    public function verify() {
        ...
        //otherwise check the normal way
            ...
            if(preg_match("/^220/i", $out = fgets($this->connect))){
                ...
                if((!$this->dont_validate_from && !preg_match("/^250/i", $from)) || !preg_match("/^250/i", $to)){
